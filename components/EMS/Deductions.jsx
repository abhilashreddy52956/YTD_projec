...
export default function Deductions() {
    ...
    const items = [
        { key: 'PF', details: [], total: '₹0' },
        { key: 'Prof', details: [], total: '₹0' },
    ];
        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                <ImageBackground source={require('../../assets/images/back.png')} style={styles.backgroundImage}>
                    <Text style={{ fontSize: 16, fontWeight: '400' }}>Your Total Deduction is</Text>
                    <Text style={{ fontSize: 20, lineHeight: 24.2, color: '#6366FF', fontWeight: '600' }}>₹ 2,854.00</Text>
                </ImageBackground>
            </View>
